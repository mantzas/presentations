...
var OrderProcessor_1 = require("./OrderProcessor");
var Repository_1 = require("./Repository");
var processor = new OrderProcessor_1.OrderProcessor(new Repository_1.Repository());
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, processor.retrieve()];
                case 1:
                    orders = _a.sent();
...
function createInternalServerErrorResponse(message) {
    return {
        body: JSON.stringify({
            error: message,
        }),
